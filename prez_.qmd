...
\rho\,L\,\frac{ds}{dt} \;=\; \bigl[\![\,k_i\,\nabla T_i \cdot \mathbf{n}\,]\!\bigr].
\end{aligned}
$$
...
- Numerical dispersion relation compared to theoretical one for different wavenumbers 
...
![Decaying dentrite](images/mullins_sekerka_temp.gif){width=50%}

![](images/amplitude_growth.png){width=50%}
