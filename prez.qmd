...
::: {layout-ncol=2}
![Ice Formation](images/ice.jpg){width=20em}

![Diphasic fire hose](images/firefighter.png){width=20em}
:::
...
T_i &= T_0 \quad \text{on } \Omega, \quad t = 0 \\
\end{aligned}
$$

![](images/heat_2ph.gif){fig-align="center"}
:::
...
![Convergence](images/heat_2ph_temp_conv.png){width="100%"}
...
- **Energy Conservation:** : Contribute to energy flux, ensuring global energy conservation even for small fluxes (e.g., constraint).
...
::: {.column}
![](images/temp_stef_1d_2ph.png){width=100% fig-align="center"}
:::
:::
...
::: {.column}
![](images/stefan_2D_2ph_temp.gif){width=100% fig-align="center"}
:::
:::
